...
//	 Convert the string to MessageChar array
     ...
     * every left path taken and a 1 for every right path). * Requires
     * Parameter: A Node that is the root tree, Empty String
     * ****************************************************************************
     */
     ...
     * added to an ArrayList. * Requires Parameter: char array * Returns:
     * ArrayList of Nodes.
     * ****************************************************************************
     */
     ...
     * function. * Requires Parameter: PriorityQueue of Nodes * Returns: A
     * single Node
     * ****************************************************************************
     */
